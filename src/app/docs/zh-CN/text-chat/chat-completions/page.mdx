export const metadata = {
  title: '对话补全',
  description: 'Cloubic 统一对话补全接口，完全兼容 OpenAI Chat Completions API 协议。',
}

# 对话补全

Cloubic 提供统一的对话补全接口，完全兼容 OpenAI Chat Completions API 协议。您只需切换 API 地址和密钥，即可无缝接入，支持 OpenAI、Anthropic、Google 等多家厂商的模型。{{ className: 'lead' }}
...
<Row>
  <Col>
    <Endpoint method="POST" path="https://api.cloubic.com/v1/chat/completions" />
...
url = 'https://api.cloubic.com/v1/chat/completions'
...
const url = 'https://api.cloubic.com/v1/chat/completions';
