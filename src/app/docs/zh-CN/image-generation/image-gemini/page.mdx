export const metadata = {
  title: 'Gemini 图像生成',
  description: 'Cloubic Gemini 系列图像生成接口，支持 Nano Banana 等模型。',
}

# Gemini 图像生成

Cloubic 目前已支持 Gemini 系列图像生成模型的统一接入与调用。Gemini 图像生成模型基于多模态对话接口，通过 Chat Completions 协议实现图像生成与编辑，支持多轮对话上下文。{{ className: 'lead' }}
