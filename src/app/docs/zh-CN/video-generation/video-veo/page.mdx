export const metadata = {
  title: 'Veo 视频生成',
  description: 'Cloubic Veo 视频生成接口，支持文生视频和图生视频。',
}

# Veo 视频生成

Cloubic 目前已支持对 Veo 视频大模型的统一接入与调用。通过本章节提供的接口说明，您可以在同一套 API 下发起视频生成请求，调用 Veo 视频生成接口生成视频。{{ className: 'lead' }}
  ...
  <Col>
    ...
    <Properties>
      <Property name="model" type="string" required>
        `kling-v2-5-turbo-std`、`kling-v2-5-turbo-pro`、`kling-v2-6`
      </Property>
      <Property name="prompt" type="string" required>
        文本提示词，生成视频的文本描述
      </Property>
      <Property name="duration" type="integer">
        视频时长参数（秒），可选值：5、10，默认 `5`
      </Property>
      ...
      <Property name="metadata" type="object">
        扩展参数（JSON 字符串格式）
        <Properties>
          <Property name="imageUrls" type="array">
            图片 URL 数组，用于图生视频。对于首尾帧生视频模式，传入 1-2 张图片（起始帧/结束帧）；对于参考生视频模式，传入 1-3 张参考图片
          </Property>
