export const metadata = {
  title: 'Kling 视频生成',
  description: 'Cloubic Kling（可灵）视频生成接口，支持文生视频和图生视频。',
}

# Kling（可灵）视频生成

Cloubic 目前已支持对 Kling（可灵）视频大模型的统一接入与调用。通过本章节提供的接口说明，您可以在同一套 API 下发起视频生成请求，调用 Kling 视频生成接口生成视频。{{ className: 'lead' }}
