    ...
    navigation: [
      ...
      },
      {
        ...
        links: [
          ...
          { title: 'Seedance 2.0 视频生成', href: '/docs/zh-CN/video-generation/video-doubao-seedance-2' },
          { title: 'MiniMax H3 视频生成', href: '/docs/zh-CN/video-generation/video-minimax-h3' },
          { title: 'Seedance 2.5 视频生成', href: '/docs/zh-CN/video-generation/video-sdance-2-5' },
