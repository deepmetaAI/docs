...
function ResourcePattern({
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className="absolute inset-0 rounded-2xl bg-linear-to-r from-[#E0E7FF] to-[#C7D2FE] opacity-0 transition duration-300 group-hover:opacity-100 dark:from-[#1E1B4B] dark:to-[#312E81]"
        style={style}
      />
      <motion.div
